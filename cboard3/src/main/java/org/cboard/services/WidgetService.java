...
public class WidgetService {
    ...
    public ServiceStatus checkRule(String userId, Long widgetId) {
        ...
        if (datasetId != null) {
            if (datasetDao.checkDatasetRole(userId, datasetId, RolePermission.PATTERN_READ, companyId) == 1) {
                return new ServiceStatus(ServiceStatus.Status.Success, "success");
            } else {
            ...
            if (datasourceDao.checkDatasourceRole(userId, datasourceId, RolePermission.PATTERN_READ, companyId) == 1) {
                return new ServiceStatus(ServiceStatus.Status.Success, "success");
            } else {
