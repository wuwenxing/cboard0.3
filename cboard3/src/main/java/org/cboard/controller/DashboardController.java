...
public class DashboardController {
    ...
    public List<ViewDashboardWidget> getAllWidgetList() {
    	User user = authenticationService.getCurrentUser();
    	String companyId = user.getCompany();
        List<DashboardWidget> list = widgetDao.getAllWidgetList(companyId);
    ...
    public List<ViewDashboardWidget> getWidgetList() {
        ...
        String userid = user.getUserId();
    	String companyId = user.getCompany();
        List<DashboardWidget> list = widgetDao.getWidgetList(userid, companyId);
        return Lists.transform(list, ViewDashboardWidget.TO);
    }
    ...
    public List<DashboardCategory> getCategoryList() {
    	User user = authenticationService.getCurrentUser();
    	String companyId = user.getCompany();
        List<DashboardCategory> list = categoryDao.getCategoryList(companyId);
        return list;
    }
    ...
    public List<String> getWidgetCategoryList() {
    	User user = authenticationService.getCurrentUser();
    	String companyId = user.getCompany();
        return widgetDao.getCategoryList(companyId);
    }
    ...
    public List<ViewDashboardDataset> getAllDatasetList() {
    	User user = authenticationService.getCurrentUser();
        String companyId = user.getCompany();
        List<DashboardDataset> list = datasetDao.getAllDatasetList(companyId);
    ...
    public List<ViewDashboardDataset> getDatasetList() {
        ...
        String userid = user.getUserId();
        String companyId = user.getCompany();
        List<DashboardDataset> list = datasetDao.getDatasetList(userid, companyId);
        return Lists.transform(list, ViewDashboardDataset.TO);
    }
    ...
    public List<String> getDatasetCategoryList() {
    	User user = authenticationService.getCurrentUser();
        String companyId = user.getCompany();
        return datasetDao.getCategoryList(companyId);
    }
    ...
    public List<ViewDashboardJob> getJobList() {
        ...
        String companyId = user.getCompany();
        String userid = user.getUserId();
        return jobDao.getJobList(userid, companyId).stream().map(ViewDashboardJob::new).collect(Collectors.toList());
    }
    ...
    public String saveBoardParam(@RequestParam(name = "boardId") Long boardId, @RequestParam(name = "config") String config) {
        ...
        boardParam.setCompanyId(companyId);
