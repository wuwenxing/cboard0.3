...
public interface DatasourceDao {
    ...
    List<DashboardDatasource> getDatasourceList(String userId, String companyId);

    List<DashboardDatasource> getDatasourceListAdmin(String userId, String companyId);
    ...
    long checkDatasourceRole(String userId, Long datasourceId, String permissionPattern, String companyId);
}
