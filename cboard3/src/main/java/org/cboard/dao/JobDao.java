...
public interface JobDao {
    ...
    List<DashboardJob> getJobList(String userId, String companyId);

    List<DashboardJob> getJobListAdmin(String userId, String companyId);
    ...
    long checkJobRole(String userId, Long jobId, String permissionPattern, String companyId);
